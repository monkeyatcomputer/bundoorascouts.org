...
<section class="py-4 not-prose" data-gsap="reveal">
  <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
    ...
    <div class="bg-surface-container-low p-8 rounded-3xl border border-outline-variant/30 relative overflow-hidden group">
      ...
      <ul class="space-y-3 text-on-surface-variant">
        <li class="flex gap-3 items-start"><span class="text-primary font-bold">•</span> Peak Awards (earned in current/previous sections)</li>
        <li class="flex gap-3 items-start"><span class="text-primary font-bold">•</span> Special Interest Area badges</li>
        <li class="flex gap-3 items-start"><span class="text-primary font-bold">•</span> Outdoor Adventure Skills (top 9 stages only)</li>
        <li class="flex gap-3 items-start"><span class="text-primary font-bold">•</span> Rover Knot (for Rover Scouts)</li>
      </ul>
    </div>
...
- **[Scouts4SDGs](https://scouts.com.au/blog/2019/05/29/scouts4sdgs/)**: Badges for initiatives like [Earth Tribe](https://earthtribe.scout.org/) or Tide Turners.
